##Usage: R script to get compile gene expression in good barcodes. Analyze top i most variable genes, with Heat Map, PCA and hcluster  
...
scatterplot3d(rot[,1],rot[,2], rot[,3],
              type="h",
              highlight.3d = T,
